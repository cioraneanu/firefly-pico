<template>
  <div class="app-form">
    ...
    <div style="margin: 16px">
      <van-button round type="primary" native-type="submit" class="app-button-save" @click="onSave"> Save </van-button>
    </div>
  </div>
</template>
...
const init = () => {
  const isListOk = appStore.transactionOrderedFieldsList.length === FORM_CONSTANTS_TRANSACTION_FIELDS_LIST.length
