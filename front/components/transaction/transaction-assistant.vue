  ...
  <div class="vant-card flex-column mt-5">
    ...
    <div class="display-flex flex-column">
      ...
      <template v-if="foundTag || foundTemplate || hasAmount">
        ...
        <div
          class="display-flex flex-center-vertical gap-2 p-5 mt-10 text-size-12 flex-wrap"
...
watch(
  [foundTemplate, foundTag, foundCategory, foundAmount, foundDescription],
  ([newTemplate, newTag, newCategory, newAmount, foundDescription]) => {
    emit('change', {
